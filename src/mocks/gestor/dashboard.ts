...
export const MOCK_ACCOUNTS = [
    { id: 'itau', name: 'Banco Itaú - CC 12345-6', balance: 'R$ 15.800,00', type: 'Banco', icon: Building2, color: 'bg-blue-500' },
    { id: 'santander', name: 'Banco Santander - CC 98765-4', balance: 'R$ 8.200,00', type: 'Banco', icon: Building2, color: 'bg-rose-500' },
    { id: 'cofre', name: 'Espécie / Cofre', balance: 'R$ 2.350,00', type: 'Espécie', icon: Wallet, color: 'bg-emerald-500' },
    { id: 'troco', name: 'Caixinha de troco', balance: 'R$ 0,00', type: 'Troco', icon: Wallet, color: 'bg-amber-500' },
    { id: 'cartao', name: 'Cartão de Crédito', balance: 'R$ 1.200,00', type: 'Cartão', icon: CreditCard, color: 'bg-purple-500' },
];
