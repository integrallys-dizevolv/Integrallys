export const MOCK_TRANSACTIONS = [
    {
        ...
        forma: 'Pix',
        status: 'Pago',
        numeroDocumento: 'REC-2026-0012',
        parcela: '1/1',
        dataEmissao: '05/11/2026',
    },
    {
        id: 2,
        data: '05/11/2026 11:15',
        tipo: 'Saída',
        unidade: 'Unidade Norte',
        descricao: 'Fornecedor - Material Hospitalar XYZ',
        ...
        forma: 'Boleto',
        status: 'Pendente',
        numeroDocumento: 'NF-89321',
        parcela: '1/2',
        dataEmissao: '01/11/2026',
    },
    {
        id: 3,
        data: '04/11/2026 16:45',
        tipo: 'Entrada',
        unidade: 'Clínica Central',
        descricao: 'Procedimento Estético - Maria Santos',
        categoria: 'Procedimento',
        valorTotal: 1200.00,
        valorPago: 600.00,
        saldo: 600.00,
        forma: 'Cartão Empresarial',
        status: 'Parcial',
        numeroDocumento: 'REC-2026-0011',
        parcela: '1/2',
    ...
    {
        id: 4,
        data: '04/11/2026 09:00',
        tipo: 'Saída',
        unidade: 'Clínica Central',
        descricao: 'Aluguel Unidade Central',
        ...
        forma: 'Transferência',
        status: 'Pago',
        numeroDocumento: 'CTR-ALUG-112',
        parcela: '1/1',
        dataEmissao: '01/11/2026',
    },
    {
        id: 5,
        data: '03/11/2026 10:20',
        tipo: 'Entrada',
        unidade: 'Unidade Norte',
        descricao: 'Exame Laboratorial - Pedro Costa',
        categoria: 'Exames',
        valorTotal: 450.00,
        valorPago: 450.00,
        saldo: 0,
        forma: 'Dinheiro',
        status: 'Pago',
        numeroDocumento: 'REC-2026-0010',
        parcela: '1/1',
        dataEmissao: '03/11/2026',
    },
];
