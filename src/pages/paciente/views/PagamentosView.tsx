...
interface PagamentosViewProps {
    mockFaturas: PatientPaymentInvoice[]
...
export function PagamentosView({ mockFaturas, onPageChange }: PagamentosViewProps) {
    ...
    const [selectedPayment, setSelectedPayment] = useState<PatientPaymentInvoice | null>(null)

    const handleOpenBoleto = (payment: PatientPaymentInvoice) => {
        setSelectedPayment(payment)
        setBoletoModalOpen(true)
    }

    const handleOpenCheckout = (payment: PatientPaymentInvoice) => {
        setSelectedPayment(payment)
