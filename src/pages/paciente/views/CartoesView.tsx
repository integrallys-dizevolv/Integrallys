...
import type { PatientEditableCardData, PatientSavedCard } from '@/types'
...
export function CartoesView({ onPageChange }: CartoesViewProps) {
    ...
    const [selectedCardForEdit, setSelectedCardForEdit] = useState<PatientEditableCardData | null>(null)
    ...
    const handleEditClick = (card: PatientSavedCard) => {
    ...
    return (
        <div className="space-y-6 animate-in fade-in duration-500">
            ...
            <EditarCartaoModal
                ...
                cardData={selectedCardForEdit || undefined}
            />
