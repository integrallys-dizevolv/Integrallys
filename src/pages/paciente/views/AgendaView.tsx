...
interface AgendaViewProps {
    ...
    onReagendar?: (appointment: PatientAppointment) => void
}
...
export function AgendaView({ mockAgendamentos, onPageChange, onReagendar }: AgendaViewProps) {
    ...
    const handleOpenDetails = (appointment: PatientAppointment) => {
        setSelectedAppointment(appointment)
        setIsDetailsOpen(true)
    }

    const handleOpenCancel = (appointment: PatientAppointment) => {
        setSelectedAppointment(appointment)
