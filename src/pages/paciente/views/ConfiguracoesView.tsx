                    ...
                    <div className="bg-app-card dark:bg-app-card-dark rounded-[14px] p-6 sm:p-8 shadow-sm border border-app-border dark:border-app-border-dark">
                        ...
                        <div className="space-y-8">
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
                                            ...
                                            <div className="space-y-2">
                                                ...
                                                <Input
                                                    ...
                                                    onChange={(e) => setFormData((prev) => ({
                                                        ...prev,
                                                        responsible: { ...prev.responsible, relationship: e.target.value }
                                                    }))}
                                                    className="h-11 rounded-[10px] bg-white dark:bg-app-bg-dark border-app-border dark:border-app-border-dark"
                                                />
                                            </div>
                                    ...
                                    {formData.financial.requiresReceipt === 'sim' && (
                                        <div className="space-y-2">
                                            ...
                                            >
                                                ...
                                                <SelectContent>
                                                    <SelectItem value="mesmos">Mesmo dados do paciente</SelectItem>
                                                    <SelectItem value="adicionar">Faturamento de terceiros</SelectItem>
                                                </SelectContent>
                                            </Select>
                                        </div>
                                    )}
                            ...
                            <div className="flex flex-col-reverse sm:flex-row justify-end gap-3 pt-2">
                                ...
                                <Button className="h-11 rounded-[10px] px-6 bg-app-primary hover:bg-app-primary/90 text-white shadow-lg shadow-blue-900/20">Salvar Alteracoes</Button>
                            </div>
                        </div>
                    </div>
                </TabsContent>
