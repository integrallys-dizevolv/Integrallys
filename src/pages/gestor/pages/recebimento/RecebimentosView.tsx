  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-500 pb-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {[
          { title: 'A Vencer / Futuro', value: formatMoney(totals.totalAberto), sub: 'Inclui saldo de pagamentos antecipados', icon: Clock, color: 'text-amber-500', bg: 'bg-amber-50 dark:bg-amber-500/10' },
          { title: 'Total Liquidado', value: formatMoney(totals.totalRecebido), sub: 'Valores conciliados', icon: TrendingUp, color: 'text-emerald-500', bg: 'bg-emerald-50 dark:bg-emerald-500/10' },
          { title: 'Atrasados', value: formatMoney(totals.totalAtrasado), sub: 'Recebimentos vencidos', icon: DollarSign, color: 'text-red-500', bg: 'bg-red-50 dark:bg-red-500/10' },
        ].map((kpi, i) => (
          <div key={i} className="p-8 bg-app-card dark:bg-[#020817] border border-gray-100 dark:border-app-border-dark shadow-sm rounded-[24px] flex flex-col justify-between hover:shadow-md transition-all duration-300 h-[210px]">
