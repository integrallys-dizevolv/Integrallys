...
import {
    ...
    FileBarChart, Download, Filter, CheckCircle, AlertCircle, CreditCard, Info, TrendingUp
} from 'lucide-react';
...
type ReportType = 'agendamentos' | 'clientes' | 'vendas' | 'orcamentos' | 'estoque' |
    'repasse' | 'nfs' | 'nfe' | 'financeiro' | 'justificativas' | 'comissoes' | 'aniversariantes';
    ...
    return (
        <div className="space-y-6 max-w-full">
            ...
            <div className="space-y-6">
                ...
                {activeReport === 'vendas' && (
                    <div className="space-y-6">
                        <StatCard title="Total em Prescrições/Vendas" value={`R$ ${totalVendas.toFixed(2)}`} color="text-green-600" bg="bg-green-100 dark:bg-emerald-900/40" icon={DollarSign} />
                        <TableWrapper>
                            <TableHeader>
                                <TableRow className="border-b border-[#dee2e6] dark:border-[#2d5a46]">
                                    <TableHead className="px-6 py-4">Data</TableHead>
