        ...
        <Dialog open={isOpen} onOpenChange={onClose}>
            <DialogContent className="max-w-[600px] w-full gap-0 h-auto max-h-[90vh] flex flex-col p-0 rounded-[24px] overflow-hidden bg-app-card dark:bg-[#0c1e3d] border border-gray-100 dark:border-app-border-dark">
                ...
                <div className="px-8 py-2 pb-8 space-y-6 overflow-y-auto custom-scrollbar flex-1">
                        ...
                        <div className="space-y-2">
                            ...
                            <Select>
                                ...
                                <SelectContent className="rounded-xl">
                                    ...
                                    <SelectItem value="produtos">Prescrição/Vendas</SelectItem>
                        ...
                        <div className="space-y-2">
                            ...
                            <Select value={paymentMethod} onValueChange={setPaymentMethod}>
                                ...
                                <SelectContent className="rounded-xl">
                                    ...
                                    <SelectItem value="cartao_empresarial">Cartão de crédito empresarial</SelectItem>
                    ...
                    {paymentMethod === 'cartao_empresarial' && (
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-5 p-4 rounded-xl border border-app-border dark:border-app-border-dark bg-app-bg-secondary/40 dark:bg-app-card/5">
                            <div className="space-y-2">
                                <Label className="text-sm font-medium text-[#101828] dark:text-white">Bandeira</Label>
                                <Input
                                    value={corporateCard.bandeira}
                                    onChange={(e) => setCorporateCard((prev) => ({ ...prev, bandeira: e.target.value }))}
                                    placeholder="Ex: Visa Business"
                                    className="h-11 rounded-xl border-app-border bg-[#F9FAFB] dark:bg-app-card/5 dark:border-app-border-dark text-sm"
                                />
                            </div>
                            <div className="space-y-2">
                                <Label className="text-sm font-medium text-[#101828] dark:text-white">Final do cartão</Label>
                                <Input
                                    value={corporateCard.final}
                                    onChange={(e) => setCorporateCard((prev) => ({ ...prev, final: e.target.value }))}
                                    placeholder="0000"
                                    className="h-11 rounded-xl border-app-border bg-[#F9FAFB] dark:bg-app-card/5 dark:border-app-border-dark text-sm"
                                />
                            </div>
                            <div className="space-y-2 md:col-span-2">
                                <Label className="text-sm font-medium text-[#101828] dark:text-white">Titular corporativo</Label>
                                <Input
                                    value={corporateCard.titular}
                                    onChange={(e) => setCorporateCard((prev) => ({ ...prev, titular: e.target.value }))}
                                    placeholder="Razão social"
                                    className="h-11 rounded-xl border-app-border bg-[#F9FAFB] dark:bg-app-card/5 dark:border-app-border-dark text-sm"
                                />
                            </div>
                            <div className="space-y-2">
                                <Label className="text-sm font-medium text-[#101828] dark:text-white">Fechamento da fatura</Label>
                                <Input
                                    value={corporateCard.fechamento}
                                    onChange={(e) => setCorporateCard((prev) => ({ ...prev, fechamento: e.target.value }))}
                                    placeholder="Dia 10"
                                    className="h-11 rounded-xl border-app-border bg-[#F9FAFB] dark:bg-app-card/5 dark:border-app-border-dark text-sm"
                                />
                            </div>
                            <div className="space-y-2">
                                <Label className="text-sm font-medium text-[#101828] dark:text-white">Vencimento da fatura</Label>
                                <Input
                                    value={corporateCard.vencimento}
                                    onChange={(e) => setCorporateCard((prev) => ({ ...prev, vencimento: e.target.value }))}
                                    placeholder="Dia 20"
                                    className="h-11 rounded-xl border-app-border bg-[#F9FAFB] dark:bg-app-card/5 dark:border-app-border-dark text-sm"
                                />
                            </div>
