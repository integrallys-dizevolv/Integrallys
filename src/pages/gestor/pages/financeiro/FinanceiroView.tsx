...
export const FinanceiroView = ({ onPageChange }: FinanceiroViewProps) => {
    const [activeTab, setActiveTab] = useState<'lancamentos' | 'caixa' | 'dre'>('lancamentos')
            ...
            <div className="flex justify-center w-full">
                <div className="w-full max-w-4xl">
                    <SegmentedControl
                        ...
                        value={activeTab}
                        onChange={(val) => setActiveTab(val as 'lancamentos' | 'caixa' | 'dre')}
                    />
                </div>
            </div>
                                    ...
                                    <Table>
                                        ...
                                        <TableBody className="divide-y divide-gray-50 dark:divide-white/5">
                                            {[
                                                ...
                                                { hora: '09:45', tipo: 'Entrada', desc: 'Prescrição/Venda de produto', forma: 'Cartão', valor: '120,00', op: 'Ana Costa', variant: 'green' },
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <div className="space-y-5">
                                            {[
                                                ...
                                                { label: 'Cartão', icon: CreditCard, value: 'R$ 120,00' },
