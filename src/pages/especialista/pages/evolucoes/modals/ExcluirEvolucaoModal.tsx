            ...
            >
                <div className="bg-white dark:bg-app-card-dark p-10">
                    ...
                    <p className="text-[#64748b] dark:text-app-text-muted text-lg leading-relaxed mb-10 font-normal">
                        Tem certeza que deseja excluir a evolução de <span className="font-normal text-gray-900 dark:text-white">{pacienteNome}</span>? Esta ação não pode ser desfeita.
                    </p>
