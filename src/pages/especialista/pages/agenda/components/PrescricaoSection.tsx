...
import type { ItemPrescrito } from '../../../context/types'
...
export const PrescricaoSection = ({ onBack, onNext }: PrescricaoSectionProps) => {
    ...
    const handleOpenLabelEditor = (item: ItemPrescrito) => {
    ...
    const updateItem = (id: number, field: 'quantidade' | 'posologia', value: number | string) => {
        if (isReadOnly) return
