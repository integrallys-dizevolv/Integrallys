...
export function FichaPacienteModal({ isOpen, onClose, paciente }: FichaPacienteModalProps) {
    ...
    // Dados fictícios para completar a ficha baseada no exemplo do usuário
    const dadosCompletos = {
        email: paciente.email || 'maria@email.com',
        endereco: paciente.endereco || 'Rua das Flores, 123',
        condicoesMedicas: paciente.condicoesMedicas || 'Hipertensão',
        historicoRecente: paciente.historicoRecente || 'Paciente apresenta quadro estável, com boa adesão ao tratamento.'
    };
                ...
                <div className="bg-white dark:bg-app-card-dark p-8 max-h-[85vh] overflow-y-auto custom-scrollbar">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-y-8 gap-x-12">
                        ...
                        <div className="space-y-1">
                            ...
                            <p className="text-lg text-gray-700 dark:text-white/80">{dadosCompletos.email}</p>
                        </div>

                        {/* Endereço */}
                        <div className="md:col-span-2 space-y-1">
                            <h4 className="text-sm font-normal text-gray-900 dark:text-white tracking-wider opacity-80">Endereço</h4>
                            <p className="text-lg text-gray-700 dark:text-white/80">{dadosCompletos.endereco}</p>
                        </div>
                        ...
                        <div className="md:col-span-2 space-y-1">
                            ...
                            <p className="text-lg text-gray-700 dark:text-white/80">{dadosCompletos.condicoesMedicas}</p>
                        </div>
                        ...
                        <div className="md:col-span-2 space-y-1">
                            ...
                            <p className="text-base text-gray-600 dark:text-app-text-muted leading-relaxed italic">
                                "{dadosCompletos.historicoRecente}"
                            </p>
                        </div>
                    </div>
                </div>
