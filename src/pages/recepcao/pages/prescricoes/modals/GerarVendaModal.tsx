                    ...
                    {isSuccess ? (
                        <div className="p-12 text-center space-y-6">
                            ...
                            <div className="space-y-2">
                                <h2 className="text-2xl font-bold text-[#101828] dark:text-white">Prescrição/Vendas gerada com sucesso!</h2>
                                <p className="text-[#667085] dark:text-gray-400 font-medium">A Prescrição/Vendas foi convertida e o estoque foi atualizado.</p>
                            </div>
                            <Button
                                onClick={() => {
                                    setIsSuccess(false)
                            ...
                            <div className="bg-gray-50/50 dark:bg-white/5 rounded-[20px] p-6 space-y-6 border border-gray-100 dark:border-gray-800">
                                <div className="flex items-start justify-between">
                                    <div className="space-y-1">
                                        <p className="text-[11px] font-bold text-[#667085] dark:text-gray-500 uppercase tracking-wider">Prescrição/Vendas</p>
