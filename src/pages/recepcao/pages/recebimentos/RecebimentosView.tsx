...
export const RecebimentosView = ({ onPageChange }: RecebimentosViewProps) => {
    ...
    const [receivables, setReceivables] = useState<ReceivableItem[]>(MOCK_RECEIVABLES)
    ...
    return (
        <div className="space-y-8 animate-in fade-in duration-500 max-w-[1600px] mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <Card className="p-6 md:p-8 rounded-[24px] shadow-sm flex items-center justify-between bg-white dark:bg-[#0c1e3d] border border-gray-100 dark:border-gray-800">
