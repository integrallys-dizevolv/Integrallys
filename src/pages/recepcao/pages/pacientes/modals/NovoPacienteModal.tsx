...
import { Phone, FileText, Printer, User, MapPin, CreditCard, Heart, Share2 } from 'lucide-react'
...
export function NovoPacienteModal({ isOpen, onClose }: NovoPacienteModalProps) {
                            ...
                            <div className="w-full max-w-lg pt-6 grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <Button variant="outline" className="h-16 rounded-2xl border-[#0039A6] text-[#0039A6] hover:bg-[#0039A6]/5 gap-4 justify-start px-6 shadow-sm group" onClick={() => window.print()}>
                                    ...
                                    <div className="text-left">
                                        <p className="text-xs font-black uppercase tracking-widest">Imprimir</p>
                                ...
                                <Button variant="outline" className="h-16 rounded-2xl border-emerald-600 text-emerald-600 hover:bg-emerald-50 gap-4 justify-start px-6 shadow-sm group" onClick={() => {
                                    const msg = encodeURIComponent(`Olá ${formData.nome}! Seu cadastro na Integrallys foi realizado com sucesso.`);
                                    ...
                                    <div className="text-left">
                                        ...
                                        <p className="text-[10px] text-gray-500 font-normal">Boas-vindas digital</p>
                                    </div>
                                </Button>
                                <Button variant="outline" className="h-16 rounded-2xl border-rose-500 text-rose-600 hover:bg-rose-50 gap-4 justify-start px-6 shadow-sm group" onClick={() => window.print()}>
                                    <div className="h-10 w-10 flex items-center justify-center bg-rose-100 rounded-xl group-hover:scale-110 transition-transform"><FileText className="h-5 w-5" /></div>
                                    <div className="text-left">
                                        <p className="text-xs font-black uppercase tracking-widest">Manual</p>
                                        <p className="text-[10px] text-gray-500 font-normal">Termos & Condições</p>
                                    </div>
                                </Button>
                                <Button variant="outline" className="h-16 rounded-2xl border-indigo-600 text-indigo-600 hover:bg-indigo-50 gap-4 justify-start px-6 shadow-sm group" onClick={() => { }}>
                                    <div className="h-10 w-10 flex items-center justify-center bg-indigo-100 rounded-xl group-hover:scale-110 transition-transform"><Share2 className="h-5 w-5" /></div>
                                    <div className="text-left">
                                        <p className="text-xs font-black uppercase tracking-widest">Enviar Ficha</p>
                                        <p className="text-[10px] text-gray-500 font-normal">Compartilhar e-mail</p>
                                    </div>
                                </Button>
                            </div>
                        </div>
