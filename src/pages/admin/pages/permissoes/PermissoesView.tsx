...
import type { PerfilPermissao, PerfilPermissaoModal } from '@/types/permissoes'

interface PermissoesViewProps {
  onPageChange?: (page: string) => void
  view?: 'lista' | 'gerenciar'
  profiles?: PerfilPermissao[]
  loading?: boolean
  error?: string | null
}
...
export function PermissoesView({
  onPageChange,
  view = 'lista',
  profiles = MOCK_PERFIS,
  loading = false,
  error = null,
}: PermissoesViewProps) {
  const [searchFilter, setSearchFilter] = useState('')
  const [selectedProfile, setSelectedProfile] = useState<PerfilPermissaoModal | null>(null)
  ...
  const filteredPermissions = useMemo(() => {
    return profiles.filter(permission => {
