...
export function FinanceiroView({ setCurrentPage }: FinanceiroViewProps) {
  ...
  const openModal = (type: string, transaction?: Transaction, defaultNatureza?: 'entrada' | 'saida') => {
  ...
  return (
    <div className="space-y-6">
      ...
      {financeTab === 'recebimentos' && (
        <RecebimentosView openModal={(type, t) => openModal(type, t, 'entrada')} />
      )}
      {financeTab === 'pagamentos' && (
        <PagamentosView openModal={(type, t) => openModal(type, t, 'saida')} />
      )}
      {financeTab === 'lancamentos' && (
        <LancamentosView openModal={openModal} />
      )}
      {financeTab === 'caixa' && (
        <CaixaView openModal={openModal} />
      )}
      {financeTab === 'dre' && (
        <DreView />
      )}
                ...
                <div className="space-y-1.5 leading-none">
                  ...
                  <Select>
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="cartao" className="font-normal text-sm">Cartão de crédito</SelectItem>
