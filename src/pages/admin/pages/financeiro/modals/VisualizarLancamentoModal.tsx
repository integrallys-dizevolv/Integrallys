                    ...
                    <div className="px-6 pb-6 space-y-3">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mt-4">
                            ...
                            <div className="p-3 bg-app-bg-secondary/50 dark:bg-app-card/[0.02] rounded-xl border border-gray-100 dark:border-app-border-dark">
                                ...
                                <p className={`text-lg font-normal ${transaction.tipo === 'Entrada' ? 'text-green-600' : 'text-red-500'}`}>
                                    R$ {(transaction.valor || transaction.valorTotal || 0).toLocaleString('pt-BR', { minimumFractionDigits: 2 })}
                                </p>
                            </div>
                            ...
                            <div className="p-3 bg-app-bg-secondary/50 dark:bg-app-card/[0.02] rounded-xl border border-gray-100 dark:border-app-border-dark">
                                ...
                                <p className="text-sm font-normal text-app-text-primary dark:text-white">{transaction.data || transaction.hora}</p>
                            </div>
                            ...
                            <div className="p-3 bg-app-bg-secondary/50 dark:bg-app-card/[0.02] rounded-xl border border-gray-100 dark:border-app-border-dark">
                                ...
                                <p className="text-sm font-normal text-app-text-primary dark:text-white">{transaction.unidade || 'Clínica Central'}</p>
                            </div>
                            ...
                            <div className="p-3 bg-app-bg-secondary/50 dark:bg-app-card/[0.02] rounded-xl border border-gray-100 dark:border-app-border-dark">
                                ...
                                <p className="text-sm font-normal text-app-text-primary dark:text-white">{transaction.operador || 'Sistema'}</p>
                            </div>
                        </div>
                        ...
                        <div className="overflow-hidden rounded-xl border border-dashed border-app-border dark:border-app-border-dark p-3 flex items-center gap-3 bg-app-bg-secondary/30 dark:bg-transparent">
                            ...
                            <p className="text-[11px] text-[#64748B] dark:text-app-text-muted leading-relaxed italic font-normal">
                                Registro gerado por {transaction.operador || 'Sistema'} em {transaction.data || transaction.hora}.
                            </p>
                        </div>
