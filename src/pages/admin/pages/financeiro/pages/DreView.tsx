...
import type { DreItem, DreItemDetail } from '@/types/financeiro';

interface DreViewProps {
    dreItemsSource?: DreItem[];
    loading?: boolean;
}

export const DreView = ({ dreItemsSource = MOCK_DRE_ITEMS, loading = false }: DreViewProps) => {
    ...
    const [dreItems, setDreItems] = useState<DreItem[]>(dreItemsSource);
    const [isGenerating, setIsGenerating] = useState(false);

    useEffect(() => {
        setDreItems(dreItemsSource);
    }, [dreItemsSource]);
    ...
    const handleGenerate = () => {
        ...
        setTimeout(() => {
            ...
            const updatedItems: DreItem[] = dreItemsSource.map(item => ({
                ...item,
        ...
        <div className="space-y-8 animate-in fade-in duration-500">
                ...
                <div className="flex flex-wrap items-end gap-4">
                    <div className="space-y-1.5 flex-1 min-w-[150px]">
                        ...
                        <Select value={dreFilters.periodo} onValueChange={(v) => setDreFilters({ ...dreFilters, periodo: v })}>
                            <SelectTrigger className="h-11 bg-[#F8FAFC] dark:bg-app-bg-dark border-app-border dark:border-app-border-dark text-sm font-medium rounded-xl">
                                <SelectValue />
                            </SelectTrigger>
                            <SelectContent>
                    ...
                    <div className="space-y-1.5 flex-1 min-w-[200px]">
                        ...
                        <div className="relative">
                            <Input
                                ...
                                className="h-11 bg-[#F8FAFC] dark:bg-app-bg-dark border-app-border dark:border-app-border-dark text-sm font-medium rounded-xl pr-10"
                            />
                    ...
                    <div className="space-y-1.5 flex-1 min-w-[200px]">
                        ...
                        <Select value={dreFilters.unidade} onValueChange={(v) => setDreFilters({ ...dreFilters, unidade: v })}>
                            <SelectTrigger className="h-11 bg-[#F8FAFC] dark:bg-app-bg-dark border-gray-100 dark:border-app-border-dark text-sm font-medium rounded-xl">
                                <SelectValue />
                            </SelectTrigger>
                            <SelectContent>
                    ...
                    <Button
                        ...
                        className="h-12 px-10 bg-[#0039A6] hover:bg-[#1a3329] text-white font-normal rounded-xl gap-2 shadow-lg shadow-[#0039A6]/10 whitespace-nowrap flex items-center min-w-[180px]"
                    >
                        {isGenerating ? (
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                <Card className="p-8 border-none shadow-sm bg-app-card dark:bg-app-bg-dark">
                    ...
                    <p className="text-3xl font-normal text-app-text-primary dark:text-white mb-2">R$ 45.320,00</p>
                ...
                <Card className="p-8 border-none shadow-sm bg-app-card dark:bg-app-bg-dark">
                    ...
                    <p className="text-3xl font-normal text-app-text-primary dark:text-white mb-2">R$ 32.338,00</p>
                ...
                <Card className="p-8 border-none shadow-sm bg-app-card dark:bg-app-bg-dark">
                    ...
                    <p className="text-3xl font-normal text-app-text-primary dark:text-white mb-2">R$ 13.688,00</p>
            ...
            <Card className="p-0 border-none shadow-sm overflow-hidden bg-app-card dark:bg-app-bg-dark">
                <div className="p-8 border-b border-gray-50 dark:border-app-border-dark">
                    <h3 className="text-xl font-normal text-app-text-primary dark:text-white mb-1">Demonstrativo de resultados do exercício</h3>
                    <p className="text-sm text-[#64748B] dark:text-app-text-muted">Novembro de 2025 - Todas as unidades</p>
                </div>
                                ...
                                <div className="flex items-center gap-6">
                                    ...
                                    <div className={['total', 'summary', 'result'].includes(item.type) ? 'pl-2' : ''}>
                                        ...
                                        <div className="flex flex-col">
                                            {item.sub && (
                                                <p className={`text-sm ${item.type === 'result' ? 'text-white/70' : 'text-[#64748B] dark:text-app-text-muted'}`}>
                                                    {item.sub}
                                                </p>
                                            )}
                                        </div>
                ...
                <div className="p-8 border-t border-gray-100 dark:border-app-border-dark bg-app-bg-secondary/30 dark:bg-app-bg-dark/50 flex flex-col sm:flex-row justify-between items-center gap-4">
                    <div className="space-y-1">
                        ...
                        <p className="text-sm text-[#64748B] dark:text-app-text-muted">Baixe o demonstrativo para {dreFilters.mesAno}</p>
                    </div>
                    <div className="flex gap-3">
                        <Button variant="outline" onClick={() => toast.info('Exportação PDF disponível em breve.')} className="h-11 px-6 rounded-xl border-app-border dark:border-app-border-dark hover:bg-app-card dark:hover:bg-app-card/5 font-normal text-app-text-primary dark:text-white whitespace-nowrap flex items-center">
                            <Download size={18} className="mr-2 shrink-0" /> Exportar PDF
                        </Button>
                        <Button variant="outline" onClick={() => toast.info('Exportação XLSX disponível em breve.')} className="h-11 px-6 rounded-xl border-app-border dark:border-app-border-dark hover:bg-app-card dark:hover:bg-app-card/5 font-normal text-app-text-primary dark:text-white whitespace-nowrap flex items-center">
