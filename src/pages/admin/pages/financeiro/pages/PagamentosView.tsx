...
export function PagamentosView({ openModal, transactions = MOCK_TRANSACTIONS, loading = false }: PagamentosViewProps) {
    ...
    const pagamentos = transactions.filter(t => t.tipo === 'Saída');
    ...
    const getStatusLabel = (status: string) => {
        if (status === 'Pendente' || status === 'Parcial') return 'À vencer';
                            ...
                            <div className="space-y-1.5">
                                ...
                                <Select value={filters.status} onValueChange={(v) => updateFilter('status', v)}>
                                    ...
                                    <SelectContent>
                                        ...
                                        <SelectItem value="a_pagar">À vencer</SelectItem>
                                    </SelectContent>
                                </Select>
                            </div>
                        ...
                        <Table>
                            <TableHeader>
                                <TableRow>
                                    ...
                                    <TableHead className="min-w-[130px] text-xs font-normal text-app-text-secondary dark:text-app-text-muted ">Nº do documento</TableHead>
                                    <TableHead className="min-w-[100px] text-xs font-normal text-app-text-secondary dark:text-app-text-muted ">Parcela</TableHead>
                                    <TableHead className="min-w-[140px] text-xs font-normal text-app-text-secondary dark:text-app-text-muted ">Forma de pagamento</TableHead>
                                    <TableHead className="min-w-[140px] text-xs font-normal text-app-text-secondary dark:text-app-text-muted ">Data de emissão</TableHead>
                            ...
                            <TableBody>
                                {pagamentos.filter(t => {
                                    ...
                                    <TableRow key={t.id}>
                                        ...
                                        <TableCell className="text-app-text-secondary dark:text-app-text-muted font-normal">{t.numeroDocumento || '-'}</TableCell>
                                        <TableCell className="text-app-text-secondary dark:text-app-text-muted font-normal">{t.parcela || '-'}</TableCell>
                                        <TableCell className="text-app-text-secondary dark:text-app-text-muted font-normal">{t.forma}</TableCell>
                                        <TableCell className="text-app-text-secondary dark:text-app-text-muted font-normal">{t.dataEmissao || '-'}</TableCell>
                                ...
                                {loading && (
                                    <TableRow>
                                        <TableCell colSpan={12} className="text-center py-12 text-app-text-secondary dark:text-app-text-muted">
